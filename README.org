...
stack exec aoc 2021 01    # Execute the given day.
stack exec aoc 2021 last  # Execute the most recent day with a source file.
stack exec aoc 2021 all   # Execute every day with a source file.
#+END_SRC
